...
cardGame.forEach((ev) => { // Parcours toute les cartes de Jeu
  ev.addEventListener("mousemove", (e) => { // Permet d'écouter l'évenement quand la souris bouge
  ...
  ev.addEventListener("mouseleave", () => { // Permet d'écouter l'évenement quand la souris quitte mon élément
